...
const Header = () => {
  ...
  //click on profile pic and get menu if true 
  ...
  const logout = () => {
    setIsMenu(false);
    localStorage.clear(); //delete user from localstorage
      //set user as null
    dispatch({
      type: actionType.SET_USER,
      user: null,
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {/* rendering dropdown after click on profile pic  */}
            {isMenu && (
              <motion.div
              ...
              >
                {/* show createItem feature only to the admin  */}
